...
[Version 1.3.1 Update info](http://www.help.wponlinestore.com/index.php?/Knowledgebase/Article/View/56/27/wp-online-store---upgrading-from-13-to-version-131-guide) 

WP Online Store is a complete eCommerce plugin for WordPress that utilizes the legendary osCommerce online store software. Hundreds of  easy to use features, integrates into ANY WordPress theme + great support. 
...
*  NEW: Grid or list view for product pages (selectable in admin area or switchable on front end by user).
*  NEW: Product sort order for visitors. Now users can sort products by price, most popular, newest, most veiwed.
*  NEW: Order editor
...
*  Ajax attribute managerAll features enabled by default for a complete ready-to-go solution.
