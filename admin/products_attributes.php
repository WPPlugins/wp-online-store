...
for ($i=0, $n=sizeof($languages); $i<$n; $i ++) {
      ...
      case 'add_product_attributes':
        ...
        tep_db_query("insert into " . TABLE_PRODUCTS_ATTRIBUTES . " (products_attributes_id,products_id,options_id,options_values_id,options_values_price,price_prefix) values (null, '" . (int)$products_id . "', '" . (int)$options_id . "', '" . (int)$values_id . "', '" . (float)tep_db_input($value_price) . "', '" . tep_db_input($price_prefix) . "')");
...
<?php
      ...
      //} else {
          ...
          $option_name = tep_db_fetch_array($option_name);
          $inputs .= $languages[$i]['code'] . ':<BR><input type="text" name="option_name[' . $languages[$i]['id'] . ']" size="32" maxlength="32" value="' . $option_name['products_options_name'] . '">&nbsp; ' . TABLE_HEADING_OPT_COMMENT . ' <input type="text" name="option_comment[' . $languages[$i]['id'] . ']" size="32" maxlength="32" value="' . $option_name['products_options_comment'] . '"><br>';
        }
...
<!--              <tr class='attributes-odd'>
                <td colspan="6" class="smallText"><?php echo "<i>" . TABLE_HEADING_OPT_HELP . "</i>"; ?></td>
              </tr> //-->
              <tr>
                <!-- <td colspan="3"><?php echo tep_black_line(); ?></td>-->
